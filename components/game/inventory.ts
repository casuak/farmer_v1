export type ItemId="hoe"|"seeds"|"water"|"scythe"|"turnip"|"wood"|"shell"|"hat"|"shirt"|"backpack"|"pistol"|"sword";
export type HandItem="hoe"|"seeds"|"water"|"scythe"|"pistol"|"sword";
...
export class InventoryModel {
  ...
  selected=0;gold=200;
  constructor(){this.slots[0]={id:"hoe",count:1};this.slots[1]={id:"seeds",count:24};this.slots[2]={id:"water",count:1};this.slots[3]={id:"scythe",count:1};this.slots[4]={id:"pistol",count:1};this.slots[5]={id:"sword",count:1};this.slots[12]={id:"hat",count:1};this.slots[13]={id:"shirt",count:1};}
  get backpack(){return this.slots[14]?.id==="backpack";}
  get hand():HandItem|null{const id=this.slots[this.selected]?.id;return id&&["hoe","seeds","water","scythe","pistol","sword"].includes(id)?id as HandItem:null;}
